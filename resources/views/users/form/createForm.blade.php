...
<div class="form-group">
	<div class="row">
		<div class="col-md-6">
			...
			{!! Form::password('password', ['id' => 'password', 'class' => 'form-control', 'placeholder' => 'Contraseña', 'required' => true]) !!}
		</div>
		<div class="col-md-6">
			<label>Repetir contraseña <span class="text-danger">*</span></label>
			{!! Form::password('password_confirmation', ['id' => 'password_confirmation', 'class' => 'form-control', 'placeholder' => 'Repita la contraseña', 'required' => true] ) !!}
		</div>
	</div>
</div>
<div class="form-group">
